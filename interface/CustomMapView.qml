...
Item {
	...
	readonly property real map_area_start_x: province_map.contentX / (metternich.defines.province_map_tile_scale * scale_factor)
	readonly property real map_area_start_y: province_map.contentY / (metternich.defines.province_map_tile_scale * scale_factor)
	readonly property real map_area_tile_width: province_map.width / (metternich.defines.province_map_tile_scale * scale_factor)
	readonly property real map_area_tile_height: province_map.height / (metternich.defines.province_map_tile_scale * scale_factor)
