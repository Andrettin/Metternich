		...
		Repeater {
			...
			PortraitGridItem {
				...
				onClicked: {
					...
					} else if (building_slot.country === metternich.game.player_domain) { //FIXME: also allow building in vassal holdings, or in friendly/neutral holdings in owned provinces
