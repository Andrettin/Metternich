...
Flickable {
	...
	readonly property real tiles_per_pixel: Math.round(1 / metternich.map.minimap_tile_scale_double / scale_factor)
	...
	ScaledImage {
		id: scaled_minimap_image
		width: minimap_image.width * scale_factor
		height: minimap_image.height * scale_factor
        source: minimap_image
	}
