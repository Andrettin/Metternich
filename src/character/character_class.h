...
class character_class final : public named_data_entry, public data_type<character_class>
{
	...
	Q_PROPERTY(int min_level MEMBER min_level READ get_min_level NOTIFY changed)
...
public:
	...
	const level_bonus_table *get_craft_bonus_table() const
	{
		...
		if (this->get_base_class() != nullptr) {
			return this->get_base_class()->get_craft_bonus_table();
		}
	...
	const level_bonus_table *get_reputation_bonus_table() const
	{
		...
		if (this->get_base_class() != nullptr) {
			return this->get_base_class()->get_reputation_bonus_table();
		}
