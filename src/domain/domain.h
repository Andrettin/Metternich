...
public:
	...
	[[nodiscard]] QCoro::Task<void> reset_game_data(const bool preserve_ruler_history);
	...
	bool has_definite_article(const culture *culture, const government_type *government_type, const domain_tier tier) const;
