...
public:
	...
	Q_INVOKABLE QVariantList get_top_level_scenarios() const;
...
signals:
	...
	void trait_choosable(const character *character, const trait_type *trait_type, const QVariantList &potential_traits);
