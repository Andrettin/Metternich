...
public:
	...
	const character *get_generated_character(const std::string &identifier) const;
	character *get_generated_character(const std::string &identifier);
...
private:
	...
	std::map<std::string, character *> generated_characters_by_identifier;
