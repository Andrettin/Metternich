...
class site_game_data final : public QObject
{
	...
	Q_PROPERTY(QString population_growth_rate READ get_population_growth_rate_qstring NOTIFY population_growth_rate_changed)
...
public:
	...
	decimillesimal_int get_population_growth_rate() const;

	QString get_population_growth_rate_qstring() const
	{
		return QString::fromStdString(this->get_population_growth_rate().to_string());
	}

	const decimillesimal_int &get_quarterly_population_growth_rate() const
	{
		return this->quarterly_population_growth_rate;
	}

	void set_quarterly_population_growth_rate(const decimillesimal_int &population_growth_rate);

	void change_quarterly_population_growth_rate(const decimillesimal_int &change)
	{
		this->set_quarterly_population_growth_rate(this->get_quarterly_population_growth_rate() + change);
	}
...
signals:
	...
	void population_growth_rate_changed();
