...
class infantry_cost_modifier_effect final : public modifier_effect<const domain>
{
public:
	explicit infantry_cost_modifier_effect(const std::string &value) : modifier_effect(value)
	{
	}
	...
	{
		scope->get_military()->change_infantry_cost_modifier((this->value * multiplier).to_int());
	}
