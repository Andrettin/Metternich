...
class free_warship_promotion_modifier_effect final : public modifier_effect<const domain>
{
public:
	...
	{
		co_await scope->get_military()->change_free_warship_promotion_count(this->promotion, (this->value * multiplier).to_int());
	}
