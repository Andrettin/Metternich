...
class cavalry_cost_modifier_effect final : public modifier_effect<const domain>
{
public:
	...
	{
		scope->get_military()->change_cavalry_cost_modifier((this->value * multiplier).to_int());
	}
