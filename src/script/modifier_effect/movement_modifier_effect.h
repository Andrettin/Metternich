...
class movement_modifier_effect final : public modifier_effect<const character>
{
public:
	explicit movement_modifier_effect(const std::string &value)
	...
	{
		scope->get_game_data()->change_movement((this->value * multiplier).to_int());
	}
