...
class free_infantry_promotion_modifier_effect final : public modifier_effect<const country>
{
public:
	...
	{
		scope->get_game_data()->change_free_infantry_promotion_count(this->promotion, (this->value * multiplier).to_int());
	}
