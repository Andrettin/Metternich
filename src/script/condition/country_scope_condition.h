...
class country_scope_condition final : public scope_condition<upper_scope_type, country, read_only_context, condition<country>>
{
public:
	explicit country_scope_condition(const gsml_operator condition_operator)
		: scope_condition<upper_scope_type, country, read_only_context, condition<country>>(condition_operator)
	{
	}
