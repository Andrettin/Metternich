...
public:
	...
	virtual bool check_assignment(const scope_type *scope, const read_only_context &ctx) const override
	{
		...
		if constexpr (std::is_same_v<scope_type, character> || std::is_same_v<scope_type, domain> || std::is_same_v<scope_type, military_unit> || std::is_same_v<scope_type, population_unit>) {
