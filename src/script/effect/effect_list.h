...
public:
	...
	std::string get_effects_string(const scope_type *scope, const read_only_context &ctx, const size_t indent = 0, const std::string &prefix = "", const bool indent_first_line = true, const std::string &separator = "\n") const;
	std::string get_effects_single_line_string(const scope_type *scope, const read_only_context &ctx) const;
