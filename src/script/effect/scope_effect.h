...
public:
	...
	[[nodiscard]] virtual QCoro::Task<void> do_assignment_effect_coro(upper_scope_type *upper_scope, context &ctx) const override final
	{
		...
		co_await this->do_scope_effect(new_scope, upper_scope, ctx);
	}
