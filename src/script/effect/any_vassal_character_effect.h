...
class any_vassal_character_effect final : public scope_effect_base<upper_scope_type, const character>
{
public:
	explicit any_vassal_character_effect(const gsml_operator effect_operator)
