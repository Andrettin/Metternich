...
class historical_military_unit_history final : public data_entry_history
{
	...
	Q_PROPERTY(std::vector<const metternich::promotion *> promotions READ get_promotions)
...
public:
	...
	Q_INVOKABLE void add_promotion(const metternich::promotion *promotion)
	{
		this->promotions.push_back(promotion);
	}

	Q_INVOKABLE void remove_promotion(const metternich::promotion *promotion)
	{
